...
class StanfordCoreNLP(object):
    ...
    def __init__(self, corenlp_path=None):
        ...
        self.corenlp.expect("done.", timeout=600) # Load pos tagger model (~5sec)
        pbar.update(1)
        self.corenlp.expect("done.", timeout=600) # Load NER-all classifier (~33sec)
        pbar.update(2)
        ...
        pbar.update(4)
        self.corenlp.expect("done.", timeout=600) # Loading PCFG (~3sec)
        pbar.update(5)
